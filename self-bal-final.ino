...
int acc_calibration_value = 2654;                            //Enter the accelerometer calibration value

//Various settings
float pid_p_gain = 15;                                       //Gain setting for the P-controller (15)
float pid_i_gain = 1.5;                                      //Gain setting for the I-controller (1.5)
float pid_d_gain = 9;                                       //Gain setting for the D-controller (30)
...
void setup(){
  ...
  //This subroutine is called TIMER2_COMPA_vect which is basically an ISR
  TCCR2A = 0;                                                               //Make sure that the TCCR2A register is set to zero
  TCCR2B = 0;                                                               //Make sure that the TCCR2A register is set to zero
  TIMSK2 |= (1 << OCIE2A);                                                  //Set the interupt enable bit OCIE2A in the TIMSK2 register(arming the interrupt)
  TCCR2B |= (1 << CS21);                                                    //Set the CS21 bit in the TCCRB register to set the prescaler to 8 which basically modifies timer clock speed to 16MHz to 
                                                                            //16/6=2MHzwhich means clock time period is 0.5us
  OCR2A = 39;                                                               //The compare register is set to 39 => 20us / (1s / (16.000.000MHz / 8)) - 1
  TCCR2A |= (1 << WGM21);                                                   //Set counter 2 to CTC (clear timer on compare) mode so that timer rolls back
  ...
  for(receive_counter = 0; receive_counter < 500; receive_counter++){       //Create 500 loops
    ...
    ///////////////////////MUST SWITCH READ ORDER FOR OUR CODE!!!!!!!////////////////////////////////////Changes currently in effect
...
void loop(){
 ...
 /* battery_voltage = (analogRead(0) * 1.222) + 85;
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  Wire.beginTransmission(gyro_address);                                     //Start communication with the gyro
  Wire.write(0x3F);                                                         //Start reading at register 3F which is acceleration in z axis
  Wire.endTransmission();                                                   //End the transmission
 ...
 // angle_gyro+=gyro_pitch_data_raw * 0.0000611;
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Interrupt routine  TIMER2_COMPA_vect exexuted every 20us
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
